...
class Calculator(ttk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        button_del.grid(row=0, column=0, columnspan=2, sticky=NSEW, padx=1)
        ...
        button_substract = ttk.Button(numpad_frame, text="-", style=SECONDARY)
        button_substract.grid(row=2, column=3, sticky=NSEW, padx=1, pady=1)
        ...
        button_equal = ttk.Button(numpad_frame, text="=", style=PRIMARY)
        button_equal.grid(row=4, column=3, sticky=NSEW, padx=1, pady=1)

app = Calculator(ttk.Window("Calculator", "superhero"))
