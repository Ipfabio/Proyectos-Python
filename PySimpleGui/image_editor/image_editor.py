...
from io import BytesIO # Convert images in something that we can use
...
control_col = sg.Column([
    [sg.Frame('Blur', layout=[[sg.Slider(range= (0,10), orientation= 'h', key='-BLUR-')]])], # puede cambiarse la 'h' por 'horizontal' y funciona igual
